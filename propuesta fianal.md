#  Propuesta Final del Proyecto: COMUNICHAIN

## 1. Justificación del Proyecto 
**Pitch del Ascensor:**  
COMUNICHAIN es una plataforma descentralizada que transforma la gestión de proyectos comunitarios al garantizar transparencia, confianza y participación activa.Permite registrar iniciativas con descripción, financiamiento y evidencias de avance, ofreciendo una visión clara y accesible para todos los involucrados, Su interfaz gráfica sencilla y adaptable asegura que cualquier usuario pueda participar y dar seguimiento en tiempo real.  
En un contexto donde la confianza en la administración de recursos es fundamental, COMUNICHAIN ofrece una solución innovadora que combina descentralización, facilidad de uso y adaptabilidad a nuevas tecnologías emergentes. Esto asegura que los proyectos no solo se planifiquen, sino que se ejecuten de manera integral hasta su culminación, generando un impacto positivo en la comunidad.
...
|--------|--------------------------------------------|-------------------|-------------|
| 1      | Diseño conceptual y definición de objetivos | Ninguna           | Equipo      |
| 2      | Desarrollo de la interfaz gráfica inicial   | Diseño conceptual | Diseñador   |
| 3      | Implementación del registro de proyectos    | Interfaz gráfica  | Backend     |
| 4      | Integración del módulo de financiamiento    | Registro proyectos| Programador |
| 5      | Módulo de evidencias y transparencia        | Financiamiento    | Equipo      |
...
**Manifiesto de Comunicación del Equipo:**

1. Todos los *issues* en GitHub deben responderse en menos de 24 horas hábiles.  
2. Las decisiones clave se documentarán en el repositorio (Issues o Wiki).  
3. Se realizarán reuniones semanales de seguimiento cada lunes a las 18:00.  
4. Todo cambio en el código debe pasar por revisión de al menos un miembro antes de integrarse.  
